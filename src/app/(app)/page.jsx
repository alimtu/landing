...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen min-w-screen">
      <div className="w-full h-full border-b border-grey-100 mb-3 lg:mb-0">
        <Image
          src="/images/titr.jpg"
          alt="Logo"
          priority
      ...
      <div className="flex flex-col lg:flex-row  lg:w-9/12 w-full lg:items-end lg:justify-end items-center justify-center gap-8 mt-12">
        <div className="lg:w-1/2 w-full px-6 lg:px-0 flex flex-col lg:gap-8 gap-4">
          ...
          <span
            className="text-lg lg:leading-9 leading-8 font-bold"
        ...
        <div className="flex flex-col lg:flex-row justify-between w-full items-center">
          ...
          <div className="lg:w-1/2 w-full relative h-96">
            <Image
              ...
              className="object-contain lg:scale-125 xxl:scale-150"
              fill
              priority
            />
          </div>
        ...
        {/* <div className="flex justify-between w-full  items-center">
          <div className="w-1/2 flex gap-4 items-end">
            <div className="flex flex-col gap-6 whitespace-nowrap">
              <span className="text-4xl font-bold">همین حالا</span>
              <span className="text-5xl text-red-500 font-bold">مسیر کنترل دیابت</span>
              <span className="text-4xl font-bold self-end">رو شروع کنید.</span>
            </div>
            <div className="bg-grey-50 rounded-2xl text-xl px-12 py-4 text-black font-bold relative top-2 whitespace-nowrap">
              خرید دوره دیابت نوع یک
            </div>
          </div>
